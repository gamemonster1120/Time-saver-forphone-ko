...
function getMoviePoster() {
  ...
  const movieUrl = `https://api.themoviedb.org/3/movie/${posterId}?api_key=${apiKey}&language=ko`;
  const creditsUrl = `https://api.themoviedb.org/3/movie/${posterId}/credits?api_key=${apiKey}&language=ko`;
